...
<?php
	...
	//////////////////////////////////////	
	echo "<form id='computerform1' method='POST'>";

	//firat select box
	echo "Computer 1: <select name='computerid1' id='computerid1'>";
	...
	//second select box
	echo "Computer 2: <select name='computerid2' id='computerid2'>";
	foreach ($computer_array as $temp){
	...
	<div style="margin-left:auto; margin-right:auto; width: 400px; float:left;">
